...
import WelcomeTimeline from '../components/about/WelcomeTimeline';
import ScriptInline from '../components/article/ScriptInline';
import Phonetic from '../components/article/Phonetic';
import ExploreCard from '../components/article/ExploreCard';

Hey! I'm Urmzd Mukhammadnaim (<Phonetic client:load ipa="ʊərˈmuːzd mʊˌhɑːmɑdˈnaɪm" />), and welcome to **imiles.me**!
...
- <PreviewLink client:load href="https://www.amazon.com/Dare-Lead-Brave-Conversations-Hearts/dp/0399592520">Dare to Lead: Brené Brown</PreviewLink>
